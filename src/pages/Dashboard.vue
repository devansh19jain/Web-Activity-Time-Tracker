<template>
  ...
  <div class="settings-tabs">
    <div class="header-block">
      <img class="d-inline-block logo" height="35" src="../assets/icons/Logo.png" />
      <p class="d-inline-block title">Web Time Tracker</p>
    </div>
...
.main {
  ...
  /* background: #c5c5c5; */
  background: linear-gradient(to right, #ececff, #fff2f4);
}
.header-block {
